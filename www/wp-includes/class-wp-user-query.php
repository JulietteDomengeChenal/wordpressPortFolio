...
class WP_User_Query {
	 ...
	 *     @type string       $meta_key            User metaboxes key. Default empty.
	 *     @type string       $meta_value          User metaboxes value. Default empty.
