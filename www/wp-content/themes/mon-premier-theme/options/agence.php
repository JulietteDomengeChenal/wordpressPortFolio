...
class AgenceMenuPage {
    ...
    public static function register(){
        ...
        add_action('admin_enqueue_script', [self::class, 'registerScripts']);
    }
    ...
    public static function registerSettings(){
        register_setting(self::GROUP, 'agence_horaire', ['default' => 'Closed']);
        register_setting(self::GROUP, 'agence_date');
        add_settings_section('agence_options_section', 'Paramètres', function (){

        }, self::GROUP);
        add_settings_field('agence_options_horaire', "Horaires ouverture", function (){
            ?>
        ...
        add_settings_field('agence_options_date', "Date ouverture", function (){
            ?>
            <input type="text" name="agence_date" value="<?= get_option('agence_date') ?>" class="montheme_datepicker">
            <?php
        }, self::GROUP, 'agence_options_section');
    }
